...
input_image = imread("C:\Users\Let`s engineer\Downloads\Digital Image Processing\spsd.jpg");  % Replace with the actual path to your grayscale image.
...
approximation_filtered_level2 = imbilatfilt(cA_2nd, 1000,1.5);

% Step 5: Apply wavelet thresholding to the detail subbands
threshold = 30;  % You may need to adjust this threshold value
